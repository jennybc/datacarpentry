...
## 2014-11-04 working around a dplyr join bug re preserving factor levels
## 2014-11-06 it's fixed now but no rush to remove this, since I don't want 
## lesson to depend on bleeding edge version of dplyr; remove later, such as
## after dplyr goes to version
lotr_tidy <- lotr_tidy %>%
